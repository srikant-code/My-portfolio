        ...
        return function o(s, u, i) {
            ...
            1: [function(e, t, r) {
                ...
                t.exports = function(p, e, g) {
                    p = m(p), (g = g || {}).summary_text = g.summary_text || 'Summary of pull requests, issues opened, and commits made by <a href="https://github.com/' + e + '" target="blank">@' + e + "</a>", g.cache = 1e3 * (g.cache || 86400), !1 === g.global_stats && (p.style.minHeight = "175px");
                    var r = "gh_calendar_content",
                        n = "gh_calendar_expire";
                    g.proxy = g.proxy || function(e) {
                    ...
                    return function f() {
                        return g.getCalendar(e).then(function(e) {
                            ...
                            if (m(".position-relative h2", r).remove(), r.querySelector(".float-left.text-gray").innerHTML = g.summary_text, r.querySelector("include-fragment")) setTimeout(f, 500);
                            else {
                                if (!0 === g.responsive) {
                                    var n = r.querySelector("svg.js-calendar-graph-svg"),
                                        a = n.getAttribute("width"),
                                        o = n.getAttribute("height");
                                    n.removeAttribute("height"), n.setAttribute("width", "100%"), n.setAttribute("viewBox", "0 0 " + a + " " + o);
                                }
                                if (!1 !== g.global_stats) {
            ...
            9: [function(e, t, r) {
                t.exports = function(e, t) {
                    var r = 0,
                        n = [];
                    if (Array.isArray(e))
                        for (; r < e.length && !1 !== t(e[r], r, e); ++r) {} else if ("object" === (void 0 === e ? "undefined" : _typeof(e)) && null !== e)
                    ...
                    s = (n(u, [{
                        ...
                        value: function value(e, t) {
                            ...
                            do {
                                ...
                                if (a) {
                                    var s = this.obj[a];
                                    "function" == typeof s && (s = s.apply(this, t)), r += s;
                                } else r += o;
...
GitHubCalendar(".calendar", "srikant-code", {
    responsive: true
});